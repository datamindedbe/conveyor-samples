with
    ...
    customers as (select * from {{ dbt_unit_testing.ref("stg_customers") }}),

    orders_mart as (select * from {{ dbt_unit_testing.ref("orders") }}),
    ...
    joined as (
        ...
        select
            ...
            case when order_summary.is_repeat_buyer then 'returning' else 'new' end as customer_type
