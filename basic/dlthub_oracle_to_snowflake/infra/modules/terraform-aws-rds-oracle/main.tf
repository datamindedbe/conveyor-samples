    ...
    Statement = [
      {
        ...
        Condition = {
          StringEquals = {
            ...
            "aws:SourceArn" : "arn:aws:rds:${var.aws_region}:${var.aws_account}:db:${aws_db_instance.rds.identifier}"
          }
        }
      }
    ]
...
resource aws_db_instance_role_association integration {

  db_instance_identifier = aws_db_instance.rds.identifier
  feature_name           = "S3_INTEGRATION"
  role_arn               = aws_iam_role.integration.arn
