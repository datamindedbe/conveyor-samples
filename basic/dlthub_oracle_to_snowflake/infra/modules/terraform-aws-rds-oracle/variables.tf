...
variable "aws_region" {
  description = "region to store the database"
  default = "eu-west-1"
}

variable "aws_account" {
  description = "AWS Account that holds S3 buckets that you want to give the database access to"
}

variable "s3_bucket" {
  description = "Name of the bucket where the RDS instance can find data to load as external tables. "
}